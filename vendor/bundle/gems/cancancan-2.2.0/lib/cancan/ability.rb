...
module CanCan
  ...
  module Ability
    ...
    #
    #   can :create, Project do |projects, remote_ip|
    #     # ...
    #   end
    #
    ...
    #
    #   can :update, Project do |projects|
    #     projects.groups.include?(user.group)
    #   end
    #
    # If the block returns true then the user has that :update ability for that projects, otherwise he
