...
class MimeMagic
  ...
  EXTENSIONS = {
    ...
    'jpf' => 'image/jp2',
    'jpg' => 'image/jpeg',
    'jpr' => 'application/x-jbuilder-projects',
    'jpx' => 'application/x-jbuilder-projects',
  ...
  TYPES = {
    ...
    'application/x-glade' => [%w(glade), %w(application/xml), 'Glade projects'],
    ...
    'application/x-jbuilder-projects' => [%w(jpr jpx), %w(), 'JBuilder projects'],
    ...
    'application/x-kexiproject-shortcut' => [%w(kexis), %w(), 'shortcut to Kexi projects on database server'],
    'application/x-kexiproject-sqlite2' => [%w(kexi), %w(application/x-sqlite2), 'Kexi database file-based projects'],
    'application/x-kexiproject-sqlite3' => [%w(kexi), %w(application/x-sqlite3), 'Kexi database file-based projects'],
