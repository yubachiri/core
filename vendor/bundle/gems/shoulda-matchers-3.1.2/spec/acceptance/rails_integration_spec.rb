...
describe 'shoulda-matchers integrates with Rails' do
  ...
  specify 'in a projects that uses the default test framework' do
    updating_bundle do
      add_gems_for_n_unit
  ...
  specify 'in a projects that uses RSpec' do
    updating_bundle do
      add_gems_for_rspec
      add_shoulda_matchers_to_project(
  ...
  specify 'in a projects that uses Spring' do
  ...
  specify 'in a projects that combines both RSpec and Test::Unit' do
    updating_bundle do
      add_gems_for_n_unit
      add_gems_for_rspec
      add_shoulda_matchers_to_project(
